...
class QwenLanguageModel(language_model.LanguageModel):
  """Language Model that uses Qwen models via DashScope API."""
  ...
  def __init__(
    ...
    Args:
      ...
      api_key: The API key to use when accessing the DashScope API. If None, will
    ...
    if api_key is None:
      ...
      if api_key is None:
        raise ValueError(
            'API key must be provided or set in DASHSCOPE_API_KEY environment variable'
        )
